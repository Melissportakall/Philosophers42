...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/08/31 11:35:48 by melisportak       #+#    #+#             */
/*   Updated: 2024/08/31 11:35:48 by melisportak      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	printf("%d %d %s\n", 0, 1, TAKE_FORK);
	sensitive_usleep(info->time_to_die);
